...
awful.keyboard.append_global_keybindings({
    ...
    awful.key(
        ...
        { description = "kill focused window", group = "awesome" }
    ),
    awful.key(
        {},
        "Print",
    ...
    awful.key(
        {modkey},
        "l",
        function() awful.spawn("blurlock") end,
...
awful.keyboard.append_global_keybindings({
    ...
    awful.key(
        ...
        function() require("bar.modules.pipewire.wireplumber").decVol(5) end,
        { description = "volume down", group = "hotkeys" }
    ),
    awful.key(
        {},
        "XF86AudioRaiseVolume",
        function() require("bar.modules.pipewire.wireplumber").incVol(5) end,
...
client.connect_signal("request::default_keybindings", function()
    awful.keyboard.append_client_keybindings({
        ...
        awful.key({ modkey }, "F2", function(c) awful.spawn.easy_async_with_shell("blurlock") end, { description = "close", group = "client" }),
