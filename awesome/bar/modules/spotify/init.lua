...
local function worker(user_args)
    ...
    local play_icon = args.play_icon or '/home/fanny/.config/awesome/play.png'
    local pause_icon = args.pause_icon or '/home/fanny/.config/awesome/pause.png'
    local font = args.font or 'Nerd Hack 10'
    ...
    local spotify_boxed = helper.box_widget({
        widget = spotify_widget,
        bg_color = beautiful.module_bg,
        margins = dpi(6),
    })

    return spotify_boxed
end
